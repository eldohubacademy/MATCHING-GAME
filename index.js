...
let scores = { 1: 0, 2: 0 };
let matchedPairs = 0;
const flags = ["https://flagcdn.com/w320/ke.png","https://flagcdn.com/w320/ug.png","https://flagcdn.com/w320/tz.png","https://flagcdn.com/w320/za.png","https://flagcdn.com/w320/cg.png","https://flagcdn.com/w320/ng.png", "https://flagcdn.com/w320/ss.png", "https://flagcdn.com/w320/ne.png", "https://flagcdn.com/w320/zm.png","https://flagcdn.com/w320/dj.png","https://flagcdn.com/w320/mr.png","https://flagcdn.com/w320/tg.png"]
// DOM elements
  ...
  cardsArray.forEach((number, index) => {
    ...
    card.innerHTML = `
            ...
            <div class="card-content back">
              <img src="${flags[number]}" width="100%" > 
            </div>
        `;
...
window.addEventListener("load", ()=>{
  document.getElementById("players").addEventListener("submit", (e)=>{
    e.preventDefault()
    document.getElementById("player-one-name").textContent = document.getElementById("player-one").value
    document.getElementById("player-two-name").textContent = document.getElementById("player-two").value
